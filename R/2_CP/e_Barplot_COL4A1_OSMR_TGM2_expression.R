...
# input -------------------------------------------------------------------
exp_df <- fread(input = "../../data/CPM.TMM_normalized.Knockout_Cell_Lines.20220524.v1.tsv.gz", data.table = F)
...
file2write <- paste0(dir_out,"F2.e_Barplot_COL4A1_OSMR_TGM2_Expression.pdf")
