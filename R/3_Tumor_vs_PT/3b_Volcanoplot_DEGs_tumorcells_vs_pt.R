...
# ## save plot data
# write.table(x = plot_data_df, file = "../../plot_data/F3b.SourceData.tsv")

# input plot data --------------------------------------------------------------
plot_data_df <- fread(data.table = F, input = "../../plot_data/F3b.SourceData.tsv")
...
file2write <- paste0(dir_out,"F3b.Volcanoplot.DEGs_tumorcells_vs_pt", ".pdf")
